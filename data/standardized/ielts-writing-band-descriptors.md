...
(General Training) All bullet points are presented but one or more may not 
...
Organisation is evident but is not wholly 
...
2
The content barely relates to the task. There is little relevant message, or the 
...
Occasional, non-systematic errors and 
inappropriaciesoccur, but have minimal 
impact on communication.
7
...
tendency to over-generaliseor there may be a lack of focus and 
...
and/or idiomatic items.
An awareness of style and collocation is 
evident, though inappropriaciesoccur.
